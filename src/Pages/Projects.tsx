    ...
    <div>
      <div className = 'projectsPreface'>
        ...
        <p className='paragraph'>The following are a collection of projects I have completed, am working on, or am planning on working on that I am proud enough to share with you.
          ...
          mind, of plunging towards the depths of insanity before reaching the breakthrough I was looking for, often something mundane yet triumphant all the same. All of them culminate
          into the reason I continue to develop despite the hardships: that implicit joy of creation for creations sake, regardless of what audience might await. <br/><br/>That being said, I hope
          you find some of these projects interesting, or amusing at the very least, if not always enjoyable.
        </p>
      </div>
